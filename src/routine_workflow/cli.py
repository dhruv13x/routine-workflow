...
def parse_arguments() -> argparse.Namespace:
  ...
  %(prog)s --code-dump-run-cmd code-dump batch run --dirs custom .
''')
    ...
    parser.add_argument('--code-dump-script', type=Path, default=Path(os.getenv('CODE_DUMP_SCRIPT', '/sdcard/tools/run_code_dump.sh')))  # Renamed for clarity; unused in binary mode
    ...
    parser.add_argument('--code-dump-run-cmd', nargs=argparse.REMAINDER, default=None, help='Override code-dump run command (base args before dynamic flags)')
